...
const BLog = () => {
    return (
        <div className="my-20">
            ...
            <div className='flex justify-center items-center mt-10 rounded-3xl bg-gradient-to-r from-slate-300 via-stone-300 to-zinc-300 sm:relative transition-all duration-300 transform sm:hover:scale-105 hover:-translate-y-2 '>
