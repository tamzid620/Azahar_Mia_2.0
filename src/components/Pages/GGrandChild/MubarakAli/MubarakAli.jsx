...
const MubarakAli = () => {
  useTitle('MubarakAli')
    ...
    return (
        ...
        <img className="w-[120px] -mb-12 rounded-sm " src={mubarak_photo} alt="" />
        </div>
...
<table className="table">
  ...
  <tbody>
    ...
    <tr key={mubarak.id}>
      ...
      <td>
        {/* ---------------- modal ------------- */}
<label htmlFor={`my_modal_${mubarak.id}`} onClick={() => setSelectedId(mubarak.id)} className="btn bg-gradient-to-r from-gray-500 via-slate-500 to-zinc-500 text-white btn-xs">
details
</label>
...
{selectedId && (
    ...
    <div className="flex items-center">
      <img className="w-[100px] rounded-sm" src={mubarak?.photo} /> <span className="text-3xl"> + </span>
      <img className="w-[100px] rounded-sm" src={mubarak?.spouse_photo} />
      </div>
...
<table className="table">
  ...
  <tbody className="font-semibold ">
    ...
    <tr>
      <td>1</td>
      <td>
        <img className="w-[75px] rounded-sm" src={mubarak?.childrens?.[0]?.grand_child_one_photo} alt="" />
      </td>
    ...
    <tr>
      <td>2</td>
      <td>
        <img className="w-[75px] rounded-sm" src={mubarak?.childrens?.[1]?.grand_child_two_photo} alt="" />
      </td>
    ...
    <tr>
      <td>3</td>
      <td>
        <img className="w-[75px] rounded-sm" src={mubarak?.childrens?.[2]?.grand_child_three_photo} alt="" />
      </td>
    ...
    <tr>
      <td>4</td>
      <td>
        <img className="w-[75px] rounded-sm" src={mubarak?.childrens?.[3]?.grand_child_four_photo} alt="" />
      </td>
    ...
    <tr>
      <td>5</td>
      <td>
        <img className="w-[75px] rounded-sm" src={mubarak?.childrens?.[4]?.grand_child_five_photo} alt="" />
      </td>
